...
// per interval, matching the payload the bindplane extension produces. It is
// set up by the processor carrying the `global` config block; without one it
// stays dormant and nothing is reported.
