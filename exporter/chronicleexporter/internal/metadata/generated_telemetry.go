...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/dynatrace/dynatrace-bindplane-otel-contrib/exporter/chronicleexporter")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/dynatrace/dynatrace-bindplane-otel-contrib/exporter/chronicleexporter")
}
